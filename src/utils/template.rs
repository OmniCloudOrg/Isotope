...
impl TemplateEngine {
    ...
    pub fn render_string(&self, template: &str, variables: &HashMap<String, String>) -> Result<String> {
    ...
    pub fn render_file(&self, template_path: &str, output_path: &str, variables: &HashMap<String, String>) -> Result<()> {
        debug!("Rendering template file: {} -> {}", template_path, output_path);
    ...
    pub fn render_registered(&self, template_name: &str, variables: &HashMap<String, String>) -> Result<String> {
        self.handlebars
